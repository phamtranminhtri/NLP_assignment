...
\fancyfoot[L]{\scriptsize \ttfamily Assignment for Natural Language Processing - Academic year 2025 - 2026}
...
\begin{center}
\begin{tabular}{c}
\multicolumn{1}{l}{\textbf{{\Large NATURAL LANGUAGE PROCESSING (CO3085)}}}\\
~~\\
\hline
\\
\multicolumn{1}{l}{\textbf{{\Large Assignment}}}\\
\\
\textbf{\textit{{\Huge “Duplicate question detection”}}}\\
\\
\hline
\end{tabular}
\end{center}
